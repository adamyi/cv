...
CS course WAM: 97.8/100 HD, relavent courses: \emph{Data Structures and Algorithms} (99/100 HD), \emph{Extended Web Application Security and Testing} (100/100  HD), \emph{Database Systems} (100/100HD), \emph{System and Software Security Assessment} (unofficial student), \emph{Cyber Security Project} (currently taking), \emph{Web Data Compression and Search} (currently taking), \emph{Extended Algorithms and Programming Techniques} (currently taking)
}
